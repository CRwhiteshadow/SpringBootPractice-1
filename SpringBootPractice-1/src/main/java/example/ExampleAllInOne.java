...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String postCreateServerOrder(){
		...
		obj.setMerchantTradeDate("2021/08/18 10:23:46");
	...
	public static String genAioCheckOutALL(){
		...
		obj.setMerchantTradeNo("testCompany004");
		obj.setMerchantTradeDate("2021/08/18 08:05:23");
		obj.setTotalAmount("500");
		obj.setTradeDesc("test Description");
		obj.setItemName("TestItem");
		obj.setReturnURL("http://220.137.20.166:9527/petpettest/ecpayreturn");
		obj.setNeedExtraPaidInfo("N");
		String form = all.aioCheckOut(obj, null);
		return form;
	}
